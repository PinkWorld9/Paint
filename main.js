...
rover1_width = 100; 
rover1_height = 90; 
background1_image = "racing.jpg"; 
rover1_image = "car1.png"; 
rover1_x = 10; rover1_y = 10;
function add() {
     background_imgTag = new Image();
      //defining a variable with a new image 
      background_imgTag.onload = uploadBackground; 
        ...
        if(keyPressed == '83') { down(); 
          ...
          if(keyPressed == '65') { left(); 
            ...
            if(keyPressed == '68') { right(); 
              console.log("right"); } }
function up() { 
  if(rover1_y >=0) { rover1_y = rover1_y - 10; 
    console.log("When w is pressed, x = " + rover1_x + " | y = " +rover1_y); 
    uploadBackground(); 
    uploadrover(); } 
  }
  function down() { 
    if(rover1_y <=500) { rover1_y =rover1_y+ 10; 
      console.log("When s is pressed, x = " + rover1_x + " | y = " +rover1_y); 
      uploadBackground(); 
      uploadrover(); } 
    }
      function left() { 
        if(rover1_x >= 0) { rover1_x =rover1_x - 10; 
          console.log("When a is pressed, x = " + rover1_x + " | y = " +rover1_y); 
          uploadBackground(); 
          uploadrover(); } 
        }
        function right() { 
          if(rover1_x <= 700) { rover1_x =rover1_x + 10; 
